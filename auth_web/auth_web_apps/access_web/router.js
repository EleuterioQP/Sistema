...
app
    ...
    .config(function($stateProvider, $urlRouterProvider, routerProvider) {
        ...
        routerProvider.setCollectionUrl('https://boxing-leaf-10460.herokuapp.com/api/auths/routers/');
        ...
        //==================================
        // para acceso a otras opciones de recuperar regstrar nuevo usuario. 
